...
public class annual{
    ...
    public static void main(String[] args) {
        ...
        if( i < 250000){
            ...
            System.out.println("Monthly Rate: " + String.format("%.2f", Monthly_Rate));
            System.out.println("Daily Rate: " + String.format("%.2f", Daily_Rate));
            System.out.println("Hourly Rat: " + String.format("%.2f", Hourly_Rate));
